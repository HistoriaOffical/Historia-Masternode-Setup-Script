...
send_fee_address() {
	...
	echo "in the Debug Console:"
        echo ""
	echo "sendtoaddress $fee_source_address 5"
        echo
	echo "------------------------------------------------------------------------------"
        echo ""
...
register_submit() {
	...
	echo ""
 	read -p "Once you see an output like 'aba8c22f8992d78fd4ff0c94cb19a5c30e62e7587ee43d5285296a4e6e5af062', you have completed the masternode process. Hit any key to continue."
...
register_end(){
	...
	echo ""
 	echo "You can also confirm that your IPFS is connecting to the Historia Network Blockchain by going to https://$domain_name/ipfs/Qmd76KSvQn51VpsputPNGgdpAQsd73E5ZRxqjhtBsrGS6b/"
